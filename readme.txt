...
Tags: WP Candidate Application Form
...
*Navigate to the "Candidate Application Forms" section to create your first form.<br>
...
= Can I have multiple versions of the Candidate Application Form on the same wordpress site? =
Yes, but only with the FULL (paid) version of *Candidate Application From*. The paid version allows users to create unlimited forms which they can customise to their needs.


== Screenshots ==
1. This screen shot shows an example of what the Candidate Application Form might look like on Job Advert posted to a WordPress template site 2. This is a screen shot of the Settings page for the Candidate Application Form plugin
...
= 1.5 =
* Major modifications to allow for multiple instances of the form to be used on a single WordPress site.

= 1.4 =
* Bug Fixes.

= 1.3 =
* Added candidate notification option.
...
= 1.3 =
Added candidate notification option for paid users.
